...
const changeReipeCategory = async function ({userId, recipeId, category, mealId}) {

  try {
      console.log(userId, recipeId, category, mealId)
    
    await Recipes.update({category: category},{
        where: {id: recipeId}
    })
...
module.exports = { changeReipeCategory };